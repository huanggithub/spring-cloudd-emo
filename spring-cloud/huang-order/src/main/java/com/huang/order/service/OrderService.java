...
import com.huang.order.entity.OrderDetail;
...
public class OrderService {
    ...
    public Order queryOrderById(String orderId) {
        ...
        ServiceInstance choose = this.loadBalancerClient.choose("app-item");
        System.out.println("第次：" + choose.getHost() + ": " + choose.getPort());
        return order;
    }

    public Order queryOrderByIdx(String id){
